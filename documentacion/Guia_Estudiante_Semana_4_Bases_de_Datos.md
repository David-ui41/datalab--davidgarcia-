...
Respuesta: El sistema no deberia permitir esta acción ya que gracias a la integridad referencial, se garantiza que al asociar un experimento con una llave, este antes debe de existir. Esto se debe a que no se puede crear una entidad debil a partir de la nada.
